...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'autoPainting' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pratik/dev/catkin_ws/src/autoPainting/${idir}'.  Ask the maintainer ' <benballa@andrew.cmu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pratik/dev/catkin_ws/src/autoPainting/build/devel/lib;/home/pratik/dev/catkin_ws/devel/lib;/opt/ros/indigo/lib)
